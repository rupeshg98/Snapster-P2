...
export class FriendServiceService {
  ...
  validateLogin(username, password) {
    ...
    return this.httpClient.post<any>('http://ec2-18-217-143-242.us-east-2.compute.amazonaws.com:8085/Snapster-P2/validateLogin', {username, password}) as Observable<Object[]>
    /*
